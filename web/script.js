...
const getInventory = async () => {
  let results = await axios.get('https://faas-lon1-917a94a7.doserverless.co/api/v1/web/fn-1c509aa6-0875-428c-b14a-8b85f581776f/cloud/getCoffee');
...
const subscribeHandler = async function() {
  ...
  let emailUrl = "https://faas-lon1-917a94a7.doserverless.co/api/v1/web/fn-1c509aa6-0875-428c-b14a-8b85f581776f/cloud/postEmai" + "?email=" + email;
